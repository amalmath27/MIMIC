...
def getStatus(logFile, txEnable):
    ...
    for count in range(len(scan_result)):
        if(scan_result[count] == '1'):    #changed this for debugging , change it later to 1 , also comment debug message
            cnt = cnt+1
    ...
    # R2 - M11, M12, M13, M14,M15, M16  # 6 inputs added on 17-10-2021  
    ...
    if((scan_result[577] == '1')  or(scan_result[576] == '1') or (scan_result[575] == '1') or (scan_result[574] == '1') or
        ...
        (scan_result[143] == '1') or(scan_result[144] == '1') or(scan_result[145] == '1') or(scan_result[146] == '1') or
        (scan_result[534] == '1') or(scan_result[535] == '1') or(scan_result[536] == '1') or(scan_result[537] == '1') or
        (scan_result[538] == '1') or(scan_result[539] == '1')):
    ...
    if((scan_result[413] == '1')   or(scan_result[412] == '1')  or (scan_result[411] == '1') or (scan_result[410] == '1') or
        ...
        (scan_result[444] == '1')  or(scan_result[445] == '1')  or(scan_result[446] == '1')  or (scan_result[447] == '1') or
        (scan_result[476] == '1')  or(scan_result[503] == '1')  or(scan_result[382] == '1')  or (scan_result[484] == '1') or
        (scan_result[485] == '1')  or(scan_result[486] == '1')  or(scan_result[487] == '1')  or (scan_result[488] == '1') or
        (scan_result[489] == '1')  or(scan_result[490] == '1')  or(scan_result[491] == '1')  or (scan_result[492] == '1') or
        (scan_result[493] == '1')  or(scan_result[494] == '1')  or(scan_result[495] == '1')  or (scan_result[496] == '1') or
        (scan_result[497] == '1')  or(scan_result[498] == '1')  or(scan_result[499] == '1')  or (scan_result[436] == '1') or
        (scan_result[437] == '1')  or(scan_result[438] == '1')  or(scan_result[429] == '1')  or (scan_result[430] == '1')):
    ...
    # R6 - M31 , M44   # new 24 inputs are added on 17-10-2021
...
def handle_crash():
    ...
    sleep(restart_timer)  # Restarts the script after 3 seconds
    start_script()
